            ...
            <div class="col-lg-5 col-md-5">
                <div class="property_video">
                    <div class="thumb w-100">
                        <img class="pro_img img-fluid" src="{{URL::to('public/uploads/course/'.$value->course_img)}}" alt="{{$value->course_img}}">
                    </div>
                </div>
            </div>
                        ...
                        <div id="C{{$chappter_course->chappter_id}}" aria-labelledby="{{$chappter_course->chappter_id}}" data-parent="#accordionExample" class="collapse">          
                            <div class="card-body pl-3 pr-3">
                                <ul class="lectures_lists">
                                    ...
                                    @foreach ($chappter_content as $keyname)
                                        @if($chappter_course->chappter_id==$keyname->chappter_id)
                                    <li>
