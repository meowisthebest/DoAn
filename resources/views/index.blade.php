					...
					<div class="col-lg-6 col-md-6 col-sm-12">
						<div class="about-short">
							...
							<div class="cource_facts">
								<ul>
									<li><span class="theme-cl">{{$count_category - 1}}+</span>Danh Mục</li>
									<li><span class="theme-cl">{{$count_course - 1}}+</span>Khóa Học</li>
									<li><span class="theme-cl">{{$count_student - 1}}+</span>Học Viên</li>
								</ul>
							</div>
							<a href="{{URL::to('/khoa-hoc')}}" class="btn btn-modern">Tìm Hiểu Thêm<span><i class="ti-arrow-right"></i></span></a>
						</div>
					</div>
							...
							@foreach ($newcourse as $key => $new_course)
								...
								<div class="singles_items">
									<div class="education_block_grid style_2">
										...
										<div style="height: 200px" class="education_block_thumb">
											<img style="background-size: cover; width: 100%; height: 100%" src="{{('public/uploads/course/'.$new_course->course_img)}}" class="img-fluid" alt="">
										</div>
										
										<div style="height: 100px" class="education_block_body">
											<h4 class="bl-title"><a href="{{URL::to('/chi-tiet-khoa-hoc/'.$new_course->course_id)}}">{{$new_course->course_name}}</a></h4>
										</div>
										
										<div style="height: 30px" class="cources_info_style3">
											<ul>
				...
				<div class="container">
					<div class="row align-items-center">
						...
						<div class="col-lg-6 col-md-6">
							<p class="mb-0">© 2020 LearnUp. Designd By <a href="#">Nguyen Minh Long - K1204A</a>.</p>
						</div>
